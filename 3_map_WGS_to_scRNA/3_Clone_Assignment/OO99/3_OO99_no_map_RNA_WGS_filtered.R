...
ggplot(plot_data, aes(x = umap_1, y = umap_2, color = Clone)) +
  ...
  geom_point(data = subset(plot_data, Clone == "6"), size = 0.8) +
...
ggsave(file.path(plot_dir_sub,paste0(patient,"_3_samples_sub_by_Clone_all_cell.pdf")),width = 10000, height= 8000 ,dpi = 1500,units = 'px')
