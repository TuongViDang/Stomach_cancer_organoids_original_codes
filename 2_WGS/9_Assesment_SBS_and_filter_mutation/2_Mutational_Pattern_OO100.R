...
unlink(plot_path, recursive = T)
dir.create(plot_path, recursive = T)

#Load the tables
mut_file = file.path(Main_dir,"output/tree_30_final/Trees/treeTable.tsv")
cluster_file = file.path(Main_dir,"output/tree_30_final/Trees/clusterInfo.txt")
tree_file= file.path(Main_dir,"output/tree_30_final/Trees/allTrees.txt")
...
vcf_names_ordered <- c( "Clone_1" ,"Clone_14", "Clone_5" ,"Clone_7", "Clone_23","Clone_4","Clone_18","Clone_2", "Clone_19","Clone_22","Clone_6","Clone_11")
...
grl <- read_vcfs_as_granges(vcf_files_ordered, vcf_names_ordered, ref_genome, type="snv", predefined_dbs_mbs=TRUE)
...
pdf(file.path(plot_path,"96_profile_each_clone.pdf"),width = 15, height = 8)
...
vcf_file <- paste0("/group/poetsch_projects/poetsch_sc/Conifer/",patient,"/tree30/each_clone/Filtered/vcf_filtered/mutation_to_rm_filtered.vcf")
ref_genome="BSgenome.Hsapiens.UCSC.hg38"
...
#Filtered 
filtered_dir= paste0("/group/poetsch_projects/poetsch_sc/Conifer/", patient,"/tree30/each_clone/Filtered/vcf_filtered")
