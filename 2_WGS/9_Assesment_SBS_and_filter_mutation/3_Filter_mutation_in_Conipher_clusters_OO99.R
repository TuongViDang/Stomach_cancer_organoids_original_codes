...
mut_file = read.delim(file.path(Main_dir,"output/tree_30/Trees/treeTable.tsv"))
table(mut_file$treeCLUSTER)

#filter cluster in tree 30
cluster_file = read.delim(file.path(Main_dir,"output/tree_30/Trees/clusterInfo.txt"))
...
#save this file
write.table(mut_file_tree_filtered,file.path(Main_dir,"output/tree_30/Trees/treeTable_filtered_artifact_Sigprofiler.tsv"), sep = "\t", quote = FALSE )