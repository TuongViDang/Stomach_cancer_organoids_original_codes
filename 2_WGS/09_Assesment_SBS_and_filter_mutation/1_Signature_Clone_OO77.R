...
SBS_long$Signature <- factor(SBS_long$Signature, levels= rev(c(   "SBS1",       "SBS5",     "SBS2",  "SBS13", "SBS3",  "SBS8",       "SBS17a",   "SBS17b",    "SBS18",      "SBS37",    "SBS39",   "SBS41",   "SBS57", "SBS58", "SBS93")))

cols_SBS = rev(c("cadetblue3","cadetblue2","slateblue1","slateblue3","tomato","bisque","palegreen1","springgreen3","hotpink1","mistyrose1","slategrey",   "lavenderblush1",  "azure3",    "gray88", "darkgray"))
